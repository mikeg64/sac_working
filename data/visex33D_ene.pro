...
close,3
openr,3,'/data/ap1vf/3D_509_36_36_300s_mf_e_1616_t.out',/f77_unf
...
close,3
openr,3,'/data/ap1vf/3D_509_36_36_30s_e_1616_t.out',/f77_unf
...
close,3
openr,3,'/data/ap1vf/3D_509_36_36_30s_mf_e_1616_t.out',/f77_unf
...
tvframe, timearr3[*,zs:508], /sample, /bar, title=tit_e, $
        xtitle='Time [s]', ytitle='z [Mm]',charsize=chsz, CT='mixct16', $
        xrange=[xx3[0], xx3[ns3[0]-1]], yrange=[aa, max(zz3)/scale]


tvframe, timearr4[*,zs:508], /sample, /bar, title=tit_e, $
        xtitle='Time [s]', ytitle='z [Mm]',charsize=chsz, CT='mixct16', $
        xrange=[xx4[0], xx4[ns4[0]-1]], yrange=[zz4[zs]/scale, max(zz4)/scale]

tvframe, timearr1[*,zs:508], /sample, /bar, title=tit_e, $
        xtitle='Time [s]', ytitle='z [Mm]',charsize=chsz, CT='mixct16', $
        xrange=[xx1[0], xx1[ns1[0]-1]], yrange=[zz1[zs]/scale, max(zz1)/scale]

tvframe, timearr2[*,zs:508], /sample, /bar, title=tit_e, $
        xtitle='Time [s]', ytitle='z [Mm]',charsize=chsz, CT='mixct16', $
        xrange=[xx2[0], xx2[ns2[0]-1]], yrange=[zz2[zs]/scale, max(zz2)/scale]
