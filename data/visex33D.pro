...
;openr,1,'/fastdata/cs1mkg/smaug/sac3d_kinktest/3D_tube_vertical.out',/f77_unf
openr,1,'/fastdata/cs1mkg/smaug/sac3d_kinktest/test199.out',/f77_unf
;openr,1,'../configs/3D_128_spic_btube1_bin.ini',/f77_unf
;openr,1,'../configs/test.ini',/f77_unf
...
wt(*,*,9)=reform(w(zstart:zend,xstart:xend,pp,9))
...
;tvframe,rotate(w(*,*,pp,9),1),/sample, /bar,title='Vz',$
;        xtitle='x', ytitle='y',charsize=2.0;, CT='dPdT'
