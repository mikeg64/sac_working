...
close,1
close,2
filename='/data/ap1vf/png/3D/tube/P120_R100_A200_B1000_Dxy2_Dz1.6_Nxy100_Nz196/normalised/slice'
close,10
openw,10,filename+'/VrVpVzbrbpbz_05Mm/Vphi_h05Mm.dat',/f77_unf
...
;image_p = TVRD_24()
;write_png,filename+'/VrVpVzbrbpbz_01Mm/'+indexss+'.png',image_p, red,green, blue

plot, tarr, psym = 4

   if n_elements(tarr) eq 2 then begin
      dtarr[0]=tarr[1]-tarr[0]
   endif else begin       
       dtarr=[dtarr,tarr[n_elements(tarr)-1]-tarr[n_elements(tarr)-2]]
   endelse 
...
save, filename=filename+'/VrVpVzbrbpbz_05Mm/a_time.sav', a_time
