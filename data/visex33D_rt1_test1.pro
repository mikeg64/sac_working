...
directory='/fastdata/cs1mkg/smaug/sac3d_kinktest/'
...
;n2=6
;pic=143500L
;for ipic=66L,pic do begin
for ipic=2,482 do begin
...
;outfile='/fastdata/cs1mkg/smaug/sac3d_kinktest/3D_tube_vertical_2.out'
outfile='/fastdata/cs1mkg/smaug/sac3d_kinktest/3D_tube_vertical_'+strtrim(string(picid),2)+'.out'
...
vmagt=dblarr(zend-zstart+1,xend-xstart+1)
vmagt=reform(vt(zstart:zend,xstart:xend,pp))
...
tvframe,rotate(wy(*,*,0),1), /bar,title='rho',$ 
        /sample, xtitle='x', ytitle='y',charsize=2.0, $
	xrange=[xx[xstart]/scale, xx[xend]/scale], $
	yrange=[zz[zstart]/scale, zz[zend]/scale]			
...
tvframe,rotate(vmagt,1),/sample, /bar,title='Vmag',$
        xtitle='x', ytitle='y',charsize=2.0; CT='dPdT'
...
image_p = TVRD_24()
write_png,'../out/im/im'+indexss+'.png',image_p, red,green, blue
