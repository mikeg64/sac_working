...
;***************************************************************************
;***************alfven speed************************************************
abx_t=abx_t ;*sqrt(mu);*1.0e4
aby_t=aby_t ;*sqrt(mu);*1.0e4
abz_t=abz_t ;*sqrt(mu);*1.0e4

Vap=sqrt((abx_t^2.d0+aby_t^2.d0+abz_t^2.d0)/arho_t)
...
timearr_vr[nn,xstart:xend-1]=reform(vr[kz,xstart:xend-1,ky])
timearr_vphi[nn,xstart:xend-1]=reform(vphi[kz,xstart:xend-1,ky])
...
dr='/data/ap1vf/png/3D/tube/P120_R100_A200_B1000_Dxy2_Dz1.6_Nxy100_Nz196/ps/time_distance/'
   ...
   device, filename=dr+'P120_Vx_ky49_kz110_Vr_Vphi_horiz_time.eps', $
...
tvframe,timearr_vr(*,*),/sample, /bar, $
        yrange=[xx[xstart]/scale, xx[xend]/scale], xrange=[0, 521], $  
        xtitle='Time [s]', ytitle='x [Mm]',charsize=1.0, CT='dPdT', $
	BTITLE='V!D r!N!3 [m/s]' 

tvframe,timearr_vphi(*,*),/sample, /bar, $
        yrange=[xx[xstart]/scale, xx[xend]/scale], xrange=[0, 521], $  
        xtitle='Time [s]', ytitle='x [Mm]',charsize=1.0, CT='dPdT', $
	BTITLE='V!D!7 u!3!N [m/s]'

;tvframe,rotate(vap(zstart:zend,xstart:xend,49),1),/sample, /bar, $
