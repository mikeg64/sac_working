...
image_p = TVRD_24()
;write_png,'/data/ap1vf/png/3D/tube/test30A/'+indexss+'.png',image_p, red,green, blue
stop
...
image_p = TVRD_24()
;write_png,'/data/ap1vf/png/3D/tube/test30A/slice/'+indexss+'.png',image_p, red,green, blue
