...
for i=0, n1-1 do begin
 ...
 Vx[i,j]=A*exp(-(r[i,j]-r0)^2.d0/deltar^2.d0)*(sin(qt*2.d0*!pi/s_period30)+sin(qt*2.d0*!pi/s_period60)+ $
                                               sin(qt*2.d0*!pi/s_period90)+sin(qt*2.d0*!pi/s_period120)) 
 Vy[i,j]=-A*exp(-(r[i,j]-r0)^2.d0/deltar^2.d0)*(cos(qt*2.d0*!pi/s_period30)+cos(qt*2.d0*!pi/s_period60)+ $
  						cos(qt*2.d0*!pi/s_period90)+cos(qt*2.d0*!pi/s_period120))	
