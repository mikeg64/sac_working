...
timearr_vr[nn,zstart:zend-1]=vr[zstart:zend-1,kx,ky]
timearr_vphi[nn,zstart:zend-1]=vphi[zstart:zend-1,kx,ky]
timearr_vz[nn,zstart:zend-1]=avz[zstart:zend-1,kx,ky]
...
dr='/data/ap1vf/png/3D/tube/P30_R100_A500_B1000_Dxy2_Dz1.6_Nxy100_Nz196/ps/time_distance/'

;   device, filename=dr+'P120_Vx_kx49_ky49_time.eps', $
;   BITS=8, /color, xsize=xs, ysize=k, /encap

   device, filename=dr+'P30_Vz_kx49_ky49_time.eps', $
   BITS=8, /color, xsize=xs, ysize=k, /encap
...
;        yrange=[zz[zstart]/scale, zz[zend]/scale], xrange=[0, 553.74], $  
...
tvframe,timearr_vz(*,*),/sample, /bar, $
        yrange=[zz[zstart]/scale, zz[zend]/scale], xrange=[0, 553.74], $  
        xtitle='Time [s]', ytitle='z [Mm]',charsize=1.0, CT='dPdT', $
	BTITLE='V!D z!3!N [m/s]'
