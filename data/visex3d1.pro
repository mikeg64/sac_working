...
w=dblarr(n3,n2,n1,nw)   ;was n1,n2,nw
wi=dblarr(n1,n2,n3)
readu,1,x
for iw=0,nw-1 do begin
 readu,1,wi
 for i=0,n2-1 do w(*,i,*,iw)=rotate(reform(wi(*,i,*)),1)
endfor
...
tvframe,-reform(w(*,*,n1/2,3)/rho(*,*,n1/2)),btitle='vy',charsize=2.0,/aspect;,/bar,/sample,xtitle='x',ytitle='z'
