...
if keyword_set(bar) then begin
  ...
  xyouts,bx-250, by+bsy/2.4, BTitle, /device $
...
;
plot,[0],[0],xrange=XRANGE,yrange=YRANGE,/nodata,/noerase,xstyle=1,ystyle=0    $
     ,  POSITION=POSITION  ,/device    $
     ,  TITLE=TITLE,XTITLE=XTITLE,YTITLE=YTITLE    $
     ,  SUBTITLE=SUBTITLE      $
     ,  TICKLEN=TICKLEN,CHARSIZE=CHARSIZE, XCharSize=1.2, YCharSize=1.2   $
     ,  XTICKS=XTICKS,XMINOR=XMINOR , YTICKS=YTICKS,YMINOR=YMINOR  $
     ,  YTICKFORMAT=YTICKFORMAT, XTICKFORMAT=XTICKFORMAT
