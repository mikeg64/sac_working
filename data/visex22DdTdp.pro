...
;openr,1,'/data/ap1vf/2_6Mnzx1023400B41.out',/f77_unf
...
if (istart eq 1) then begin
   TP=T
    ...
    tvframe, (T-TP)/TP,title='(P-P!I0!N)/P!I0!N',/bar, xtitle='x [Mm]', ytitle='z [Mm]',charsize=1.0,/sample, $
...
if (istart eq 1) then begin
   ...
   istart=2
    ...
    tvframe, T-TT,title='T-T!I0!N [K]',/bar, xtitle='x [Mm]', ytitle='z [Mm]',charsize=1.0,/sample, $
          xrange=[xmin/scale, xmax/scale],yrange=[zmin/scale, zmax/scale]
...
image_p = TVRD_24()
write_png,'/data/ap1vf/png/REAL/DPDT_P30_R100_A500_B45_Dx4_Dz4_6_1976_400/'+indexss+'.png',image_p, red,green, blue
